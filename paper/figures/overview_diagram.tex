...
% =====================================================================
\node[graybox, minimum width=3.2cm, minimum height=1.05cm] (xc) at (8.2, 3.6)
    {Circuit features $\mathbf{x}_c$\\ structure $+$ angles $\boldsymbol{\theta}$};
\node[graybox, minimum width=3.2cm, minimum height=1.05cm] (xn) at (8.2, 1.0)
    {Noise features $\mathbf{x}_n$\\ error rates, readout, drift $\delta$, budget $1/\sqrt{S}$};

\node[orangebox, minimum width=2.6cm, minimum height=1.05cm] (mlpc) at (11.45, 3.6)
    {Circuit encoder\\ $\mathrm{MLP}_c$ $[256, 512]$};
\node[orangebox, minimum width=2.6cm, minimum height=1.05cm] (mlpn) at (11.45, 1.0)
    {Noise encoder\\ $\mathrm{MLP}_n$ $[128, 256]$};
